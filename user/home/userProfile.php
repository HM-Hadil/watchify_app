...
<!-- Main Content Section for Dynamic Content -->
<main class="container my-5" id="mainContent">
    <!-- Default content to be replaced dynamically -->
    <h2>Bienvenue sur Watchify!</h2>
    <p>Explorez notre large sélection de montres.</p>
</main>

<!-- Footer -->
<footer class="bg-dark text-white py-4">
    <div class="container text-center">
        <p>&copy; 2024 Watchify. Tous droits réservés.</p>
    </div>
</footer>
